    ...
    <div className="w-full  ">
     <div className="text-center md:text-left ">
      ...
      <div className="flex justify-center items-center mt-10">
        <Button
          btnName="Buy Challenge - $750"
          btnType="submit"
          classForButton="text-black "
          icon={<MdArrowOutward />}
          bgColor="#14F194"
          to={"https://trader.sureleveragefunding.com/checkout?add-to-cart=161"}
        />
      </div>
    </div>
  );
