  ...
  return (
    <div className="w-full  ">
      <div className="text-left ">
        ...
        <span className="text-4xl text-[#14F194] font-semibold ">$50,000</span>
      </div>
      {/* challenge details */}
      ...
      <div className="flex justify-center items-center mt-10">
        <Button
          ...
          icon={<MdArrowOutward />}
          bgColor="#14F194"
          to={"https://trader.sureleveragefunding.com/checkout?add-to-cart=197"}
        />
      </div>
    </div>
  );
...
export default SuperElite50k1Step;
