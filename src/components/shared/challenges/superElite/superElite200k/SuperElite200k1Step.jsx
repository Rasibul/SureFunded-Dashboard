    ...
    <div className="w-full  ">
      <div className="text-left ">
        <h3 className="text-3xl font-semibold mt-5 mb-3">
          1 Step - Super Elite Challenge
        </h3>
        <span className="text-4xl text-[#14F194] font-semibold ">$200,000</span>
      </div>
      {/* challenge details */}
      <div className="w-full overflow-x-auto md:overflow-x-hidden py-10">
        <div className="min-w-[140%] md:min-w-[100%]">
          <div className="h-5 flex">
            <div className="w-2/5 md:w-1/3 lg:w-2/5"></div>
            <div className=" grid grid-cols-2 w-3/5 md:w-2/3 lg:w-3/5 ">
          ...
          <div className="min-h-16 flex">
            ...
            <div className=" grid grid-cols-2 w-3/5 md:w-2/3 lg:w-3/5 ">
              ...
              <div className=" flex items-center justify-center">Funded</div>
            </div>
          </div>

          {challengeDetails.map((step, index) => (
            <div key={index} className="min-h-16 flex">
              <div className="w-2/5 md:w-1/3 lg:w-2/5 flex items-center  text-left  justify-start lg:pl-20">
                {step.title}
              </div>
              <div className="grid grid-cols-2 w-3/5 md:w-2/3 lg:w-3/5">
      ...
      <div className="flex justify-center items-center mt-10">
        <Button
          btnName="Buy Challenge"
          btnType="submit"
          classForButton="text-black "
          icon={<MdArrowOutward />}
          bgColor="#14F194"
          to={"https://trader.sureleveragefunding.com/checkout?add-to-cart=199"}
        />
      </div>
    </div>
  );
...
export default SuperElite200k1Step;
