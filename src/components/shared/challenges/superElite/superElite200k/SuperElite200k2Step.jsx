    ...
    <div className="w-full  ">
      ...
      <div className="flex justify-center items-center mt-10">
        <Button
          ...
          icon={<MdArrowOutward />}
          bgColor="#14F194"
          to={"https://trader.sureleveragefunding.com/checkout?add-to-cart=251"}
        />
      </div>
    </div>
  );
...
export default SuperElite200k2Step;
