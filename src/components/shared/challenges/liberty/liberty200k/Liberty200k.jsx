  ...
  return (
    <div className="w-full  ">
     <div className="text-center md:text-left ">
        <h3 className="text-3xl font-semibold mt-5 mb-3">Liberty</h3>
      ...
      <div className="flex justify-center items-center mt-10">
        <Button
          btnName="Buy Challenge - $799"
          btnType="submit"
          classForButton="text-black "
          icon={<MdArrowOutward />}
          bgColor="#14F194"
          to={"https://trader.sureleveragefunding.com/checkout?add-to-cart=219"}
        />
      </div>
    </div>
  );
